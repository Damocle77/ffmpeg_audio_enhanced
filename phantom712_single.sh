#!/bin/bash
# Script Bash per Phantom Atmos 7.1.2 – Singolo file
# Simulazione avanzata Atmos: aggiunge surround posteriori e height

#!/bin/bash
# =============================================================================
# SCRIPT: Super commentato – singolo file per Phantom Atmos 7.1.2
# =============================================================================
...
set "OUTPUT=$INPUT:.mkv=-sideheight712-cinematic.mkv$"
